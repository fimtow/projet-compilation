...
const char* keyword_token[] = {"if", "else", "for", "while", "number", "text","is","bouton","with","bool","true","false"};
...
typedef enum{
    // keywrods tokens
    IF_TOKEN, ELSE_TOKEN, FOR_TOKEN, WHILE_TOKEN, NUMBER_TOKEN, STR_TOKEN, IS_TOKEN, BOUTTON_TOKEN, WITH_TOKEN,BOOL_TOKEN,TRUE_TOKEN,FALSE_TOKEN,
    // Symbole tokens
...
const char* tokens[] = {"IF_TOKEN", "ELSE_TOKEN", "FOR_TOKEN", "WHILE_TOKEN", "NUMBER_TOKEN", "STR_TOKEN","IS_TOKEN","BOUTTON_TOKEN","WITH_TOKEN","BOOL_TOKEN","TRUE_TOKEN",
"FALSE_TOKEN","PLUS_TOKEN", "MINUS_TOKEN", "DIV_TOKEN", "STAR_TOKEN", "COMMA_TOKEN", "SEMICOLON_TOKEN", "OPEN_BRACE_TOKEN",
